...
pid="${1:?usage: launch_trace_mistral_tenacity_from_pid.sh PID_WITH_NVIDIA_API_KEY TRACE_LABEL}"
trace_label="${2:?usage: launch_trace_mistral_tenacity_from_pid.sh PID_WITH_NVIDIA_API_KEY TRACE_LABEL}"
...
echo "launched ${trace_label} mistral tenacity grader"
